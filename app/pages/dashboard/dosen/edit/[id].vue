...
onMounted(async () => {
  ...
  const d = dDosen.data || dDosen;
  form.value = { ...d, nidn: d.nidn||'', nip: d.nip||'', tmt: d.tmt||'', jenis_kelamin: d.jenis_kelamin?'1':'0' };
});
    ...
    <div class="glass-panel">
      ...
      <form @submit.prevent="update" class="grid-form">
        ...
        <div class="full-width">
          <button type="submit" class="btn-save" style="background:orange;">Update</button>
...
<style scoped>
/* Gunakan Style yang sama dengan create.vue */
